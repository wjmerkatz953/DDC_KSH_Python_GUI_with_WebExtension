...
class QtISNIDetailedSearchTab(BaseSearchTab):
    ...
    def create_input_section(self, parent_layout):
        ...
        self.input_layout.setContentsMargins(6, 6, 6, 10)
        ...
        self.kac_input.setPlaceholderText("예: KAC201309056, KAC2019E8167")
        ...
        self.input_layout.addWidget(self.kac_input, 0, 1)
    ...
    def get_search_params(self):
        ...
        """
        kac_code = self.kac_input.text().strip()
    ...
    def search_by_kac_code(self, kac_code):
        ...
        # 1. 검색창에 KAC 코드 입력
        self.kac_input.setText(kac_code)
