...
변경 이력:
v2.2.0 (2025-10-29)
- [버그 수정] Search_Naver.py의 교보문고 스크레이핑 로직 개선
  : scrape_kyobo_book_info 함수가 저자, 번역자 등 모든 'writer_info_box'를 수집하도록 .find()를 .find_all()로 수정
  : 번역자의 다른 작품 목록이 누락되던 문제 해결
...
class MainApplicationWindow(QMainWindow):
    ...
    def setup_ui(self):
        """UI 설정"""
        self.setWindowTitle("통합 검색 시스템 - Qt Model/View Edition V. 5.0.9 Beta for PNU Library 자료조직팀 by InnovaNex")
